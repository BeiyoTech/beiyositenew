...
const Counter = ({ from, to, duration = 3 }) => {
  ...
  return (
    <div className="hostel-container w-full max-w-7xl mx-auto px-4 py-12 space-y-24">
      {/* Features Section */}
      <motion.section 
        className="features-section relative bg-slate-50 overflow-hidden rounded-2xl shadow-lg"
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <div className="features-content-wrapper grid md:grid-cols-2 gap-8 items-center relative z-10 p-8 md:p-12">
          ...
          >
            <motion.h1 
              className="features-title text-4xl md:text-5xl font-bold text-gray-800"
              variants={fadeInUp}
            >
              Hassle Free <span className="features-title-highlight text-yellow-500 ">Move-In.</span>
            </motion.h1>
            <motion.p 
              className="features-title text-3xl md:text-3xl font-medium text-gray-600"
              variants={fadeInUp}
            >
            ...
            >
              {[
                ...
                >
                  ...
                  <span className="feature-text text-lg md:text-xl text-gray-600">{item.text}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
      ...
      {/* Community Section */}
      <motion.section 
        className="community-section relative bg-slate-50 overflow-hidden rounded-2xl shadow-lg"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
        variants={fadeInUp}
        ...
        <div className="community-content-wrapper grid md:grid-cols-2 gap-8 items-center relative z-10 p-8 md:p-12">
          ...
          >
            <motion.h2 
              ...
              variants={fadeInUp}
            >
              We are not just yet another <span className="text-yellow-500">Hostel!</span>
            </motion.h2>
            ...
            >
              {[
                ...
                >
                  ...
                  <span className="text-lg md:text-xl text-gray-600">{item.text}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
