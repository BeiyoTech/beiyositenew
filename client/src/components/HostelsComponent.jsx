  ...
  <div className="flex gap-1">
    {['Boys', 'Girls', 'All'].map((type) => (
      <button
        ...
        className={`px-4 py-[2px] rounded-md text-sm font-medium transition duration-200 ${
      ...
      >
        {type}
                ...
                <div className="w-full md:w-auto p-4 rounded-lg bg-white/50 border border-white/30">
